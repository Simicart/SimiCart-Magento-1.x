 ...
 * Time: 2:34 PM
 */
class Simi_Simiconnector_Model_Catemap extends Mage_Sitemap_Model_Resource_Catalog_Category {
...
//        Zend_debug::dump($this->getMainTable());
...
//        Zend_debug::dump($this->getMainTable());die();
